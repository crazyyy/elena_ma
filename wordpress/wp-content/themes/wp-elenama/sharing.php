...
<div class="article--share">
  <a href="https://facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank" aria-label="" class="article--share__fb"><i class="ico-soc--share_fb"></i>читать на facebook</a>

  <span href="#" class="article--share__share"><i class="ico-soc--share"></i>
  <div class="share-buttons">
    <!-- Sharingbutton Twitter -->
    <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=<?php echo $title; ?>&amp;url=<?php the_permalink(); ?>" target="_blank" aria-label="">
    ...
    <a class="resp-sharing-button__link" href="https://www.tumblr.com/widgets/share/tool?posttype=link&amp;title=<?php echo $title; ?>&amp;caption=<?php echo $title; ?>&amp;content=<?php the_permalink(); ?>&amp;canonicalUrl=<?php the_permalink(); ?>&amp;shareSource=tumblr_share_button" target="_blank" aria-label="">
    ...
    <a class="resp-sharing-button__link" href="mailto:?subject=<?php echo $title; ?>&amp;body=<?php the_permalink(); ?>" target="_self" aria-label="">
    ...
    <a class="resp-sharing-button__link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php the_permalink(); ?>&amp;title=<?php echo $title; ?>&amp;summary=<?php echo $title; ?>&amp;source=<?php the_permalink(); ?>" target="_blank" aria-label="">
    ...
    <a class="resp-sharing-button__link" href="whatsapp://send?text=<?php echo $title; ?>%20<?php the_permalink(); ?>" target="_blank" aria-label="">
    ...
    <!-- Sharingbutton VK -->
    <a class="resp-sharing-button__link" href="http://vk.com/share.php?title=<?php echo $title; ?>&amp;url=<?php the_permalink(); ?>" target="_blank" aria-label="">
    ...
    <a class="resp-sharing-button__link" href="https://telegram.me/share/url?text=<?php echo $title; ?>&amp;url=<?php the_permalink(); ?>" target="_blank" aria-label="">
